...
2. ### **Once you've acquired the key, proceed to creating a new install and click "Next".**
   ...
   ![3CX Phone system installation page. ](_images/bc04289576e9d186.png)
...
4. ### **Choose whether your IP address is "static" or "dynamic" and click "next".**
   ...
   ![Public IP installation page. ](_images/db16f19f5bbfba68.png)
5. ### **Select the ports required for 3CX Management console. They automatically populate default values for you but you can choose your own.**
   ...
   ![Port selection for web services installation page. ](_images/eee74b1cfbe01fc8.png)
6. ### **Proceed to select the default network adapter.**

   ![Default Network Adapter. ](_images/1fa57dc4b67a1e84.png)
7. ### **Your FQDN and certificates will now be generated.**

   ![FQDN and certificates installation page. ](_images/4be2beba3b5845e9.png)
8. ### **Select how many digits your extensions should have.**

   ![3CX extension length. ](_images/b231c2701cec333e.png)
9. ### **Enter an Email for important system notifications.**

   ![Admin Email for important system notifications. ](_images/7e92f539933e2e1e.png)
10. ### **Select Country and Time Zone.**

    ![country and time zone installation page. ](_images/f480674f4cb0aa67.png)
11. ### **Create an Operator Extension.**

    ![Operator extension installation page. ](_images/44f91a26a015c2ac.png)
12. ### **As an additional security measure, you can specify to which countries calls can be made.**

    ![Preferred language installation page. ](_images/7f9559ffe077dfb5.png)
13. ### **Select your preferred language.**

    ![Preferred language installation page. ](_images/8806d3799c4cfeeb.png)
...
16. ### **Log in with the "username" and "password" you created.**
    ...
    ![3CX management console. ](_images/db555806817dd70e.png)
17. ### **You'll be brought the the dashboard now.**

    ![3CX management dashboard console. ](_images/c15947baf44935a9.png)
